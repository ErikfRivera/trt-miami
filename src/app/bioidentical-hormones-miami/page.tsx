...
const { citations: bioCitations, lastReviewed: bioLastReviewed } = pageCitations(PAGE_PATH);
...
const schemaNodes = [
  ...
  buildPageCitationSchema(PAGE_PATH, bioCitations),
];
